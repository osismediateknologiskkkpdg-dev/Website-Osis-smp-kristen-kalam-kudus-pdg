...
// Helper pembuat angka acak 6 digit
function generateSixDigitOTP() {
    return Math.floor(100000 + Math.random() * 900000).toString();
}

/**
 * Endpoint Baru: POST /api/resend-otp
 */
router.post('/resend-otp', async (req, res) => {
    try {
        ...
        // Jalur penyimpanan User_data.json di root folder
        ...
        const newOtpCode = generateSixDigitOTP();
        ...
        // Simpan perubahan data ke User_data.json
        fs.writeFileSync(userDataPath, JSON.stringify(usersData, null, 2), 'utf8');

        console.log(`[Resend OTP] Kode baru untuk ${email}: ${newOtpCode}`);
        ...
        console.error("[API Error Resend OTP]:", error);
